  ...
  static render(
    ...
    const body = html`<div class="max-w-lg mx-auto space-y-6">
      <div>
        ...
        <h1 class="mt-1 text-2xl font-bold tracking-tight text-zinc-50">댓글 삭제</h1>
      ...
      >
        ...
        <div class="flex items-center justify-end gap-2 pt-2">
          <a href="/board/${board.slug}/post/${String(post.id)}#comments" class="${GHOST_BUTTON_CLASS}">취소</a>
